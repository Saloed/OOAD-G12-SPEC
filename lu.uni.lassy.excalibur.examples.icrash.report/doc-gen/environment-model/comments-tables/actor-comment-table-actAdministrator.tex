...
\begin{actortable}
	...
	\addnumbereddoublerow{IN}{\msrcode{ieTimeStatisticUpdated(AdtCoordStatistic:dtCoordStatistic):ptBoolean}}
							 {its reception confirms the update of coordinators timing statistic}
