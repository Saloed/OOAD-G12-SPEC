...
\begin{actortable}
	...
	\addnumbereddoublerow{OUT}{\hypertarget{actActivator.outactActivator.oeUpdateTimingStatistic}
			{\msrcode{[proactive] oeUpdateTimingStatistic(ACoordStatistic:dtCoordStatistic):ptBoolean}}}
			{ }
