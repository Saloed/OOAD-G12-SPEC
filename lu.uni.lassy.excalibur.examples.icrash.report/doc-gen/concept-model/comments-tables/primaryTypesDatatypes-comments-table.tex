...
\adddoublerow{dtBiometric}{a data type using to store user biometric information}
\addsingletwocolumnrow{extends}{dtInteger}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{determine validity of biometric information}
...
\adddoublerow{dtCoordStatistic}{store coordinator timing statistic}
\adddoubletwocolumnrow{attribute}{\msrcode{coordId: dtCoordinatorID}}{Id of the coordinator}
\adddoubletwocolumnrow{attribute}{\msrcode{coordState: ptString}}{State of the coordinator (free,handle...)}
\adddoubletwocolumnrow{attribute}{\msrcode{coordTime: dtTime}}{Time of the last coordinator's state change}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{determine validity of coordinator timing statistic}
