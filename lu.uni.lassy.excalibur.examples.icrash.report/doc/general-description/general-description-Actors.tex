...
\begin{itemize}
  ...
  \item to use text passwords and biometric information for login.
\end{itemize}
...
\begin{itemize}
  ...
  \item to controll coordinators activities using coordinators timing statistic.
\end{itemize}
...
\begin{itemize}
  ...
  \item to notify the administrator that one of coordinators change his status.
\end{itemize}
\vspace{0.5cm}
